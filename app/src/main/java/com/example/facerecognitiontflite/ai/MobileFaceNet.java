...
public class MobileFaceNet {
    ...
    private static final int INPUT_SIZE_HEIGHT = 112;
    private static final int INPUT_SIZE_WIDTH = 112;
     ...
     */
    public static MobileFaceNet create(final AssetManager assetManager) {
        final MobileFaceNet f = new MobileFaceNet();
