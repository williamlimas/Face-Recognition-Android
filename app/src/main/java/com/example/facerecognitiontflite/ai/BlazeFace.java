...
public class BlazeFace {
    ...
    private static ByteBuffer loadModelFile(AssetManager assets) throws IOException {
    ...
    private static float CalculateScale(int stride_index, int num_strides) {
        return BlazeFace.MIN_SCALE +
                (BlazeFace.MAX_SCALE - BlazeFace.MIN_SCALE) * 1.0f * stride_index / (num_strides - 1.0f);
    }
     ...
     */
    public static BlazeFace create(final AssetManager assetManager) {
